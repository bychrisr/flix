...
export const componentSizes = {
  ...
  videoPlayer: {
    overlayHeight: '213px',
    progressTrackWidth: '1330px',
    progressTrackHeight: '8px',
    progressThumbSize: '16px',
    volumeRailWidth: '34px',
    volumeRailHeight: '146px',
    volumeBarWidth: '12px',
    optionPanelWidth: '584px',
    optionPanelHeight: '568px',
    nextEpisodeCardWidth: '700px',
    nextEpisodeCardHeight: '274px',
  },
  movieCard: {
