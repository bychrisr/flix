...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Lesson page renders video player for authorized lessons
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) Adjacent lesson navigation (previous/next) is available when applicable
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Basic anti-abuse/embed constraints are applied in player integration
