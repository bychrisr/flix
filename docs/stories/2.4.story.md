...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Dashboard exposes counts for events and lessons
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) Dashboard shows lesson release status distribution baseline
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Data is sourced from API endpoints with auth protection
