...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Learner app runs with framework runtime and consumes public catalog/access APIs.
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) Catalog and lesson playback flows reflect release/private access states correctly.
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Navigation between lessons and access messaging is clear and consistent.
