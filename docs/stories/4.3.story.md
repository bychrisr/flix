...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Quiz CRUD supports multiple questions and options
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) Validation enforces at least one correct option per question
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Quiz structure persists consistently in database relations
