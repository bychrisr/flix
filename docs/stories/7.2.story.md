...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Admin UI supports event and lesson CRUD flows with validation feedback.
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) Materials and quiz management flows are fully available from admin screens.
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Branding controls are available in admin flow and integrate with backend branding APIs.
