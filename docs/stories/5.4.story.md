...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Core journey smoke tests pass for admin and learner flows
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) Security baseline checks are verified for production profile
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Open blockers are documented with explicit go/no-go status
