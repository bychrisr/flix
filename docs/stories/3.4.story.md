...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Countdown UI appears when lesson is not yet released
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) Countdown is derived from server timestamps to avoid client drift issues
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Status transitions are reflected correctly after release time
