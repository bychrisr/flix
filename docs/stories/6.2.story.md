...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Repository contracts are defined for all core entities.
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) In-memory access logic is replaced by repository-backed service implementations.
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Core service unit/integration tests validate behavior parity with previous API contracts.
