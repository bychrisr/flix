...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Learner can submit one quiz attempt payload per flow
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) System calculates score and pass/fail outcome
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Result view displays score summary and status
