...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Admin app has runnable framework runtime and environment-based API configuration.
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) Login flow integrates with existing admin auth endpoint and stores session context safely.
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Protected admin routes block unauthenticated access and handle expired sessions.
