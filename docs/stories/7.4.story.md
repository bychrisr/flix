...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Materials listing and download actions are accessible in released lessons.
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) Quiz execution and result screens integrate with submit/result APIs.
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Learner UX handles loading/empty/error states for materials and quiz flows.
