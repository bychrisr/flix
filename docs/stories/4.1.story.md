...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Admin can upload multiple files to a lesson
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) File type and size validation is enforced
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Uploaded assets are linked and retrievable per lesson
