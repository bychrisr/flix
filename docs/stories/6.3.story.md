...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Create/update/delete flows write to persistent storage for all core domains.
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) Public and admin read endpoints return data from persistent storage consistently.
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Runtime configuration supports local and managed database profiles via environment variables.
