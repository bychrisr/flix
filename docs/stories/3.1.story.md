...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Event landing displays hero content and lesson catalog
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) Each lesson card displays status: released, locked, or expired
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Catalog rendering consumes API data and handles empty/error states
  - [ ] Implement technical changes required for AC 3
  - [ ] Add validation/tests for AC 3
- [ ] Task 4 (AC: 4) Private events require successful access validation before catalog rendering
