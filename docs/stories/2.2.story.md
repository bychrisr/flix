...
## Tasks / Subtasks
- [ ] Task 1 (AC: 1) Event form supports hero text and visual style configuration fields
  - [ ] Implement technical changes required for AC 1
  - [ ] Add validation/tests for AC 1
- [ ] Task 2 (AC: 2) Stored visual configuration is retrievable through event APIs
  - [ ] Implement technical changes required for AC 2
  - [ ] Add validation/tests for AC 2
- [ ] Task 3 (AC: 3) Validation prevents malformed style payloads
